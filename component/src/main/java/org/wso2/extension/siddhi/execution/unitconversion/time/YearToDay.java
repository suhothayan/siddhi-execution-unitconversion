...
@Extension(
        ...
        examples = @Example(
                ...
                description = "The value in years from 'UnitConversionForYearToDayStream' input stream is " +
                        "converted into days and returned to the 'OutMediationStream' output stream."
        )
)
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:yTod() function, " +

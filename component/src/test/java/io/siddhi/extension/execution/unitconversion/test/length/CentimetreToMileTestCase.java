...
public class CentimetreToMileTestCase {
    ...
    public void testProcessForCentimetreToMile4() throws Exception {
        logger.info("UnitConversionForCentimetreToMileFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForCentimetreToMileStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForCentimetreToMileStream "
                + " select unitconversion:cmTomi() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test (expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForCentimetreToMile5() throws Exception {
        logger.info("UnitConversionForCentimetreToMileFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForCentimetreToMileStream (inValue string); ";
    ...
    @Test
    public void testProcessForCentimetreToMile6() throws Exception {
        logger.info("UnitConversionForCentimetreToMileFunctionExtension6 TestCase");

...
/**
 * Siddhi Function for UnitConversion Milli litre to Litre
 */
@Extension(
        name = "mlTol",
        namespace = "unitconversion",
        description = "Function converts the input given in milliliters into liters.",
        ...
        examples = @Example(
                syntax = "unitconversion:mlTol(1000)",
                description = "The milliliters value `1000` is converted into liters as `1`."
        )
)
public class MillilitreToLitre extends FunctionExecutor {
    ...
    /**
     * The initialization method for MillilitreToLitre, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = MILLI(LITRE).getConverterTo(LITRE);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:mlTol() function, " +

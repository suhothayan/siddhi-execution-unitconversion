...
public class YearToDayTestCase {
    ...
    public void testProcessForYearToDay() throws Exception {
        ...
        String siddhiApp = "define stream UnitConversionForYearToDayStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForYearToDayStream "
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 365.2525, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler("UnitConversionForYearToDayStream");
    ...
    public void testProcessForYearToDay3() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 7.843737707758676E11, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler("UnitConversionForYearToDayStream");
    ...
    public void testProcessForYearToDay4() throws Exception {
        logger.info("UnitConversionForYearToDayFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForYearToDayStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForYearToDayStream "
                + " select unitconversion:yTod() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForYearToDay5() throws Exception {
        logger.info("UnitConversionForYearToDayFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForYearToDayStream (inValue string); ";
    ...
    @Test
    public void testProcessForYearToDay6() throws Exception {
        logger.info("UnitConversionForYearToDayFunctionExtension6 TestCase");

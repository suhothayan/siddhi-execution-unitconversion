...
/**
 * Siddhi Function for UnitConversion Second to Millisecond
 */
@Extension(
        name = "sToms",
        namespace = "unitconversion",
        description = "Function converts the input given in seconds into milliseconds.",
        ...
        returnAttributes = @ReturnAttribute(
                description = "Returns the value in milliseconds.",
...
public class SecondToMillisecond extends FunctionExecutor {
    ...
    /**
     * The initialization method for SecondToMillisecond, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = SECOND.getConverterTo(MILLI(SECOND));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:sToms() function, " +

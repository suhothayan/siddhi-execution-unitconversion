...
public class SecondToMicrosecondTestCase {
    ...
    public void testProcessForSecondToMicrosecond() throws Exception {
        ...
        String siddhiApp = "define stream UnitConversionForSecondToMicrosecondStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForSecondToMicrosecondStream "
                + " select unitconversion:sTous(inValue) "
        ...
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler
                ("UnitConversionForSecondToMicrosecondStream");
    ...
    public void testProcessForSecondToMicrosecond4() throws Exception {
        logger.info("UnitConversionForSecondToMicrosecondFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForSecondToMicrosecondStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForSecondToMicrosecondStream "
                + " select unitconversion:sTous() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForSecondToMicrosecond5() throws Exception {
        logger.info("UnitConversionForSecondToMicrosecondFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForSecondToMicrosecondStream (inValue string); ";
    ...
    @Test
    public void testProcessForSecondToMicrosecond6() throws Exception {
        logger.info("UnitConversionForSecondToMicrosecondFunctionExtension6 TestCase");

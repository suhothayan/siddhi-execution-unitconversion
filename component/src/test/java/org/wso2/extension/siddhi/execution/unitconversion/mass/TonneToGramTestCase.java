...
public class TonneToGramTestCase {
    ...
    public void testProcessForTonneToGram() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForTonneToGramStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForTonneToGramStream "
                + " select unitconversion:TonneTog(inValue) "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForTonneToGramStream");

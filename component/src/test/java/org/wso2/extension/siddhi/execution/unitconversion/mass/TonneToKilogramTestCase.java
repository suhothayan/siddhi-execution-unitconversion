...
public class TonneToKilogramTestCase {
    ...
    public void testProcessForTonneToKilogram() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForTonneToKilogramStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForTonneToKilogramStream "
                + " select unitconversion:TonneTokg(inValue) "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForTonneToKilogramStream");

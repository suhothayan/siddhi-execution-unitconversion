...
/**
 * Siddhi Function for UnitConversion Kilometre to Mile
 */
@Extension(
        name = "kmTomi",
        namespace = "unitconversion",
        description = "This converts the input given in kilometers into miles.",
        parameters = @Parameter(
                name = "p1",
                description = "The value that needs to be converted from kilometers into miles.",
        ...
        examples = @Example(
                syntax = "unitconversion:kmTomi(inValue) as UnitConversionValue \n",
                description = "The value in kilometers is converted into miles."
        )
)
public class KilometreToMile extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilometreToMile, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = KILO(METRE).getConverterTo(mile);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kmTomi() function, " +

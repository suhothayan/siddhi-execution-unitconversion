...
public class KilometreToMetreTestCase {
    ...
    public void testProcessForKilometreToMetre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForKilometreToMetreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForKilometreToMetreStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForKilometreToMetreStream");

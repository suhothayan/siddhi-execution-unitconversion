...
public class CentimetreToMillimetreTestCase {
    ...
    public void testProcessForCentimetreToMillimetre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForCentimetreToMillimetreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForCentimetreToMillimetreStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForCentimetreToMillimetreStream");
    ...
    public void testProcessForCentimetreToMillimetre3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 2.147483647E10, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForCentimetreToMillimetreStream");

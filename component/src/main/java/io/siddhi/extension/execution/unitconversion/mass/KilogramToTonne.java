...
@Extension(
        ...
        examples = @Example(
                ...
                description = "The value in kilograms from 'UnitConversionForKilogramToTonneStream' input stream is" +
                        " converted into tonnes and returned to the 'OutMediationStream' output stream."
        )
)

...
/**
 * Siddhi Function for UnitConversion Gram to Kilogram
 */
@Extension(
        name = "gTokg",
        namespace = "unitconversion",
        description = "Converts the input grams into kilograms",
        parameters = @Parameter(
                name = "p1",
                description = "The value needed to be converted from grams into kilograms",
                type = {DataType.INT, DataType.LONG, DataType.FLOAT, DataType.DOUBLE}),
        returnAttributes = @ReturnAttribute(
                description = "The value converted from grams to kilograms",
                type = {DataType.DOUBLE}),
        examples = @Example(
                description = "The gram values from UnitConversionForGramToKilogramStream will be " +
                        "converted to kilograms and inserted in to the OutMediationStream",
...
public class GramToKilogram extends FunctionExecutor {
    ...
    /**
     * The initialization method for GramToKilogram, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
            siddhiAppContext) {
        converter = GRAM.getConverterTo(KILO(GRAM));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:gTokg() function, " +

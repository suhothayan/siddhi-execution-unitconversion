...
/**
 * Siddhi Function for UnitConversion Centimetre to Kilometre
 */
public class CentimetreToKilometre extends FunctionExecutor {
    ...
    /**
     * The initialization method for CentimetreToKilometre, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        converter = CENTI(METRE).getConverterTo(KILO(METRE));
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to unitconversion:CentimetreToKilometre() function, " +

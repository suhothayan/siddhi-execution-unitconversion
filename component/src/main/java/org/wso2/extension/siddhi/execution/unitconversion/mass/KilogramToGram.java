...
/**
 * Siddhi Function for UnitConversion Kilogram to Gram
 */
@Extension(
        name = "kgTog",
        ...
        parameters = @Parameter(
                name = "p1",
                description = "The value needed to be converted from kilograms into grams",
...
public class KilogramToGram extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilogramToGram, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
            siddhiAppContext) {
        converter = KILOGRAM.getConverterTo(GRAM);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kgTog() function, " +

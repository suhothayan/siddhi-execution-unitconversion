...
/**
 * Siddhi Function for UnitConversion Second to Nanosecond
 */
@Extension(
        name = "sTons",
        namespace = "unitconversion",
        description = "Converts the the input seconds into nanoseconds",
...
public class SecondToNanosecond extends FunctionExecutor {
    ...
    /**
     * The initialization method for SecondToNanosecond, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
            siddhiAppContext) {
        converter = SECOND.getConverterTo(NANO(SECOND));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:sTons() function, " +

...
@Extension(
        ...
        description = "Function converts the input given in tonnes into kilograms.",
        ...
        examples = @Example(
                syntax = "unitconversion:tTokg(1)",
                description = "The tonne value `1` is converted into kilograms as `1000.0`."
        )
)

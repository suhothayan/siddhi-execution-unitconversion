...
public class KilogramToOunceTestCase {
    ...
    public void testProcessForKilogramToOunce() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForKilogramToOunceStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForKilogramToOunceStream "
                + " select unitconversion:kgToOunce(inValue) "
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    Assert.assertEquals((Double) 35.27396583786957, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForKilogramToOunceStream");
    ...
    public void testProcessForKilogramToOunce3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 7.575026480166154E10, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForKilogramToOunceStream");

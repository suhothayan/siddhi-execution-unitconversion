...
public class KilometreToMicrometreTestCase {
    ...
    public void testProcessForKilometreToMicrometre() throws Exception {
        ...
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler
                ("UnitConversionForKilometreToMicrometreStream");
    ...
    public void testProcessForKilometreToMicrometre4() throws Exception {
        logger.info("UnitConversionForKilometreToMicrometreFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilometreToMicrometreStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilometreToMicrometreStream "
                + " select unitconversion:kmToum() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForKilometreToMicrometre5() throws Exception {
        logger.info("UnitConversionForKilometreToMicrometreFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilometreToMicrometreStream (inValue string); ";
    ...
    @Test
    public void testProcessForKilometreToMicrometre6() throws Exception {
        logger.info("UnitConversionForKilometreToMicrometreFunctionExtension6 TestCase");

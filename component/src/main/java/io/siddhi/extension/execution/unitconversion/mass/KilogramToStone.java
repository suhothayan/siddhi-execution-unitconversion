 ...
 * under the License.
 */
package io.siddhi.extension.execution.unitconversion.mass;
...
/**
 * Siddhi Function for UnitConversion Kilogram to Stone
 */
@Extension(
        name = "kgTost",
        ...
        examples = @Example(
                ...
                description = "The value in kilograms from 'UnitConversionForKilogramToStonemStream' input stream is " +
                        "converted into imperial stones and returned to the 'OutMediationStream' output stream."
        )
)
public class KilogramToStone extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilogramToStone, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        Unit<Mass> stone = KILOGRAM.divide(0.157473);
        converter = KILOGRAM.getConverterTo(stone);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kgTost() function, " +

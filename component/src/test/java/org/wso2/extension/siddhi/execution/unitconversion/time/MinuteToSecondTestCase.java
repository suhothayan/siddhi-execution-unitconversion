...
public class MinuteToSecondTestCase {
    ...
    public void testProcessForMinuteToSecond() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForMinuteToSecondStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForMinuteToSecondStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMinuteToSecondStream");

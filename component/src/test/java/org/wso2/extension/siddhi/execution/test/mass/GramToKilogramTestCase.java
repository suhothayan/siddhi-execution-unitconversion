...
public class GramToKilogramTestCase {
    ...
    public void testProcessForGramToKilogram4() throws Exception {
        logger.info("UnitConversionForGramToKilogramFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForGramToKilogramStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForGramToKilogramStream "
                + " select unitconversion:gTokg() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForGramToKilogram5() throws Exception {
        logger.info("UnitConversionForGramToKilogramFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForGramToKilogramStream (inValue string); ";
    ...
    @Test
    public void testProcessForGramToKilogram6() throws Exception {
        logger.info("UnitConversionForGramToKilogramFunctionExtension6 TestCase");

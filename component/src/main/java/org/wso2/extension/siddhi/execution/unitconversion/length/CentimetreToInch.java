...
/**
 * Siddhi Function for UnitConversion Centimetre to Inch
 */
...
@Extension(
        ...
        parameters = @Parameter(
                name = "p1",
                description = "The value needed to be converted from centimeters into inches",
...
public class CentimetreToInch extends FunctionExecutor {
    ...
    /**
     * The initialization method for CentimetreToInch, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
        ...
        converter = CENTI(METRE).getConverterTo(inch);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException("Invalid no of arguments passed to unitconversion:cmToIn" +

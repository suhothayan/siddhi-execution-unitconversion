...
public class LitreToMillilitreTestCase {
    ...
    public void testProcessForLitreToMillilitre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForLitreToMillilitreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForLitreToMillilitreStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForLitreToMillilitreStream");

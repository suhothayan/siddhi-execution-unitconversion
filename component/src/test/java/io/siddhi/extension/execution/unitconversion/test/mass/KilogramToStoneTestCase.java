...
public class KilogramToStoneTestCase {
    ...
    public void testProcessForKilogramToStone() throws Exception {
        ...
        String siddhiApp = "define stream UnitConversionForKilogramToStoneStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilogramToStoneStream "
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 0.157473, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler("UnitConversionForKilogramToStoneStream");
    ...
    public void testProcessForKilogramToStone3() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 3.38170692344031E8, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler("UnitConversionForKilogramToStoneStream");
    ...
    public void testProcessForKilogramToStone4() throws Exception {
        logger.info("UnitConversionForKilogramToStoneFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilogramToStoneStream (inValue int); ";
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForKilogramToStone5() throws Exception {
        logger.info("UnitConversionForKilogramToStoneFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilogramToStoneStream (inValue string); ";
    ...
    @Test
    public void testProcessForKilogramToStone6() throws Exception {
        logger.info("UnitConversionForKilogramToStoneFunctionExtension6 TestCase");

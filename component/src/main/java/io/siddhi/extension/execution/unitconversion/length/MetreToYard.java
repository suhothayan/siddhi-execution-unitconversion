...
/**
 * Siddhi Function for UnitConversion Metre to Yard
 */
@Extension(
        name = "mToyd",
        namespace = "unitconversion",
        description = "Function converts the input given in meters into yards.",
...
public class MetreToYard extends FunctionExecutor {
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = METRE.getConverterTo(yard);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:mToyd() function, " +

...
/**
 * Siddhi Function for UnitConversion Litre to Cubic metre
 */
@Extension(
        name = "lTom3",
        namespace = "unitconversion",
        description = "Function converts the input given in liters into cubic meters.",
        ...
        returnAttributes = @ReturnAttribute(
                description = "Returns the value in cubic meters.",
                type = {DataType.DOUBLE}),
        examples = @Example(
                syntax = "unitconversion:lTom3(1000)",
                description = "The liters value `1000` is converted into cubic meters as `1`.")
)
public class LitreToCubicmetre extends FunctionExecutor {
    ...
    /**
     * The initialization method for LitreToCubicmetre, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = LITRE.getConverterTo(CUBIC_METRE);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:lTom3() function, " +

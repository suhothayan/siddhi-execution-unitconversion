...
/**
 * Siddhi Function for UnitConversion Gram to Milligram
 */
@Extension(
        name = "gTomg",
        ...
        parameters = @Parameter(
                name = "p1",
                description = "The value needed to be converted from grams into milligrams",
...
public class GramToMilligram extends FunctionExecutor {
    ...
    /**
     * The initialization method for GramToMilligram, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
                        siddhiAppContext) {
        converter = GRAM.getConverterTo(MILLI(GRAM));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:gTomg() function, " +

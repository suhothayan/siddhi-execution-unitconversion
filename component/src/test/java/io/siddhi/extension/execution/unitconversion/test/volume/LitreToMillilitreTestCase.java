...
public class LitreToMillilitreTestCase {
    ...
    public void testProcessForLitreToMillilitre4() throws Exception {
        logger.info("UnitConversionForForLitreToMillilitreFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForLitreToMillilitreStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForLitreToMillilitreStream "
                + " select unitconversion:lToml() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForLitreToMillilitre5() throws Exception {
        logger.info("UnitConversionForForLitreToMillilitreFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForLitreToMillilitreStream (inValue string); ";
    ...
    @Test
    public void testProcessForLitreToMillilitre6() throws Exception {
        logger.info("UnitConversionForForLitreToMillilitreFunctionExtension6 TestCase");

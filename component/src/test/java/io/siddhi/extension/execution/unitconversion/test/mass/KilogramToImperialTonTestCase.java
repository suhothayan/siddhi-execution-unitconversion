...
public class KilogramToImperialTonTestCase {
    ...
    public void testProcessForKilogramToImperialTon() throws Exception {
        ...
        String siddhiApp = "define stream UnitConversionForKilogramToImperialTonStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilogramToImperialTonStream "
                + " select unitconversion:kgToLT(inValue) "
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 0.000984207, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler
                ("UnitConversionForKilogramToImperialTonStream");
    ...
    public void testProcessForKilogramToImperialTon3() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 2113568.437762929, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler
    ...
    public void testProcessForKilogramToImperialTon4() throws Exception {
        logger.info("UnitConversionForKilogramToImperialTonFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilogramToImperialTonStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilogramToImperialTonStream "
                + " select unitconversion:kgToLT() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForKilogramToImperialTon5() throws Exception {
        logger.info("UnitConversionForKilogramToImperialTonFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilogramToImperialTonStream (inValue string); ";
    ...
    @Test
    public void testProcessForKilogramToImperialTon6() throws Exception {
        logger.info("UnitConversionForKilogramToImperialTonFunctionExtension6 TestCase");

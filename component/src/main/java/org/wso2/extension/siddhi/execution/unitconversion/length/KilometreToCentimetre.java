...
/**
 * Siddhi Function for UnitConversion Kilometre to Centimetre
 */
public class KilometreToCentimetre extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilometreToCentimetre, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        converter = KILO(METRE).getConverterTo(CENTI(METRE));
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to unitconversion:KilometreToCentimetre() function, " +

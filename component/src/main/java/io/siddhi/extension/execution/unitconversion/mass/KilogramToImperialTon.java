...
public class KilogramToImperialTon extends FunctionExecutor {
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        Unit<Mass> imperialTon = KILOGRAM.divide(0.000984207);
        converter = KILOGRAM.getConverterTo(imperialTon);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kgToLT() function, " +

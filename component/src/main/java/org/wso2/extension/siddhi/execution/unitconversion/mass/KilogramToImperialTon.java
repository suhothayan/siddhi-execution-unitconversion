...
/**
 * Siddhi Function for UnitConversion Kilogram to ImperialTon
 */
public class KilogramToImperialTon extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilogramToImperialTon, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        Unit<Mass> IMPERIAL_TON = KILOGRAM.divide(0.000984207);
        converter = KILOGRAM.getConverterTo(IMPERIAL_TON);
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to unitconversion:KilogramToImperialTon() function, " +

...
/**
 * Siddhi Function for UnitConversion Metre to Millimetre
 */
@Extension(
        name = "mTomm",
        namespace = "unitconversion",
        description = "Converts the the input meters into millimeters",
...
public class MetreToMillimetre extends FunctionExecutor {
    ...
    /**
     * The initialization method for MetreToMillimetre, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
                        siddhiAppContext) {
        converter = METRE.getConverterTo(MILLI(METRE));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:mTomm() function, " +

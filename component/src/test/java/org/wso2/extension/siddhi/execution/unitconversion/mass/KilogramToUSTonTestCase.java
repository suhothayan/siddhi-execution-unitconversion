...
public class KilogramToUSTonTestCase {
    ...
    public void testProcessForKilogramToUSTon() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForKilogramToUSTonStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForKilogramToUSTonStream "
                + " select unitconversion:kgToUSTon(inValue) "
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    Assert.assertEquals((Double) 0.00110231, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForKilogramToUSTonStream");
    ...
    public void testProcessForKilogramToUSTon3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 2367192.69892457, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForKilogramToUSTonStream");

...
/**
 * Siddhi Function for UnitConversion Hour to Minute
 */
@Extension(
        name = "hTom",
        ...
        examples = @Example(
                ...
                description = "The value in hours from 'UnitConversionForHourToMinuteStream' input stream is" +
                        "converted into minutes and returned to the 'OutMediationStream' output stream."
        )
)
public class HourToMinute extends FunctionExecutor {
    ...
    /**
     * The initialization method for HourToMinute, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
            siddhiAppContext) {
        converter = HOUR.getConverterTo(MINUTE);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:hTom() function, " +

...
public class KilometreToFootTestCase {
    ...
    public void testProcessForKilometreToFoot4() throws Exception {
        logger.info("UnitConversionForKilometreToFootFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilometreToFootStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilometreToFootStream "
                + " select unitconversion:kmToft() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test (expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForKilometreToFoot5() throws Exception {
        logger.info("UnitConversionForKilometreToFootFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilometreToFootStream (inValue string); ";
    ...
    @Test
    public void testProcessForKilometreToFoot6() throws Exception {
        logger.info("UnitConversionForKilometreToFootFunctionExtension6 TestCase");

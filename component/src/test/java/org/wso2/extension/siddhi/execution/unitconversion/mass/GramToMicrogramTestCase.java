...
public class GramToMicrogramTestCase {
    ...
    public void testProcessForGramToMicrogram() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForGramToMicrogramStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForGramToMicrogramStream "
                + " select unitconversion:gToMicrogram(inValue) "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForGramToMicrogramStream");

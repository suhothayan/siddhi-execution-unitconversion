...
public class GramToMilligramTestCase {
    ...
    public void testProcessForGramToMilligram() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForGramToMilligramStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForGramToMilligramStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForGramToMilligramStream");

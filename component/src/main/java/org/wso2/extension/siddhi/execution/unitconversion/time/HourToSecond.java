...
/**
 * Siddhi Function for UnitConversion Hour to Second
 */
@Extension(
        name = "hTos",
        ...
        examples = @Example(
                ...
                description = "The value in hours from 'UnitConversionForHourToSecondStream' input stream is" +
...
public class HourToSecond extends FunctionExecutor {
    ...
    /**
     * The initialization method for HourToSecond, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = HOUR.getConverterTo(SECOND);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:hTos() function, " +

...
/**
 * Siddhi Function for UnitConversion Kilometre to Inch
 */
@Extension(
        name = "kmToin",
        ...
        returnAttributes = @ReturnAttribute(
                description = "The value returned in inches.",
        ...
        examples = @Example(
                ...
                description = "The value in kilometers obtained from 'UnitConversionForKilometreToInchStream' " +
...
public class KilometreToInch extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilometreToInch, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
            siddhiAppContext) {
        Unit<Length> inch = METRE.multiply(2.54E-02);
        converter = KILO(METRE).getConverterTo(inch);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kmToin() function, " +

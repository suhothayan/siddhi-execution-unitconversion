...
public class MetreToMillimetreTestCase {
    ...
    public void testProcessForMetreToMillimetre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForMetreToMillimetreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForMetreToMillimetreStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMetreToMillimetreStream");

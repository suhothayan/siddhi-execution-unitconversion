...
@Extension(
        ...
        examples = @Example(
                ...
                description = "The value in miles from 'UnitConversionForMileToKilometreStream' input stream is " +
                        "converted into kilometers and returned to the 'OutMediationStream' output stream."

...
/**
 * Siddhi Function for UnitConversion Megametre to Kilometre
 */
@Extension(
        name = "MmTokm",
        namespace = "unitconversion",
        description = "This converts the input given in megameters into kilometers.",
        ...
        examples = @Example(
                ...
                description = "The value in megameters from 'UnitConversionForMegametreToKilometreStream' " +
                        "input stream is converted into kilometers and returned to the 'OutMediationStream'" +
                        " output stream."
        )
)
public class MegametreToKilometre extends FunctionExecutor {
    ...
    /**
     * The initialization method for MegametreToKilometre, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = MEGA(METRE).getConverterTo(KILO(METRE));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:MmTokm() function, " +

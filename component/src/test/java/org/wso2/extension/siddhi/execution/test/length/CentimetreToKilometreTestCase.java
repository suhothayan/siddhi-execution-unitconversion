...
public class CentimetreToKilometreTestCase {
    ...
    public void testProcessForCentimetreToKilometre() throws Exception {
        ...
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler
                ("UnitConversionForCentimetreToKilometreStream");
    ...
    public void testProcessForCentimetreToKilometre4() throws Exception {
        logger.info("UnitConversionForCentimetreToKilometreFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForCentimetreToKilometreStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForCentimetreToKilometreStream "
                + " select unitconversion:cmTokm() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForCentimetreToKilometre5() throws Exception {
        logger.info("UnitConversionForCentimetreToKilometreFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForCentimetreToKilometreStream (inValue string); ";
    ...
    @Test
    public void testProcessForCentimetreToKilometre6() throws Exception {
        logger.info("UnitConversionForCentimetreToKilometreFunctionExtension6 TestCase");

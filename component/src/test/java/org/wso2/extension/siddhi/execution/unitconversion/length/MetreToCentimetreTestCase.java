...
public class MetreToCentimetreTestCase {
    ...
    public void testProcessForMetreToCentimetre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForMetreToCentimetreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForMetreToCentimetreStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMetreToCentimetreStream");
    ...
    public void testProcessForMetreToCentimetre3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 2.147483647E11, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMetreToCentimetreStream");

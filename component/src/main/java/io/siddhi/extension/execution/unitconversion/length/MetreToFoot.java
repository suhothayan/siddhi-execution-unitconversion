...
/**
 * Siddhi Function for UnitConversion Metre to Foot
 */
@Extension(
        name = "mToft",
        namespace = "unitconversion",
        description = "Function converts the input given in meters into foot.",
        ...
        examples = @Example(
                ...
                description = "The meter value `1` is converted into foot as `3.280`."
        )
)
public class MetreToFoot extends FunctionExecutor {
    ...
    /**
     * The initialization method for MetreToFoot, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        Unit<Length> foot = METRE.multiply(0.3048);
        converter = METRE.getConverterTo(foot);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:mToft() function, " +

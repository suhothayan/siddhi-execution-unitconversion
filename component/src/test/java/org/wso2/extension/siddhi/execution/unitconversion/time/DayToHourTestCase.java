...
public class DayToHourTestCase {
    ...
    public void testProcessForDayToHour() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForDayToHourStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForDayToHourStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForDayToHourStream");
    ...
    public void testProcessForDayToHour3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 5.1539607528E10, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForDayToHourStream");

...
public class MetreToFootTestCase {
    ...
    public void testProcessForMetreToFoot() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForMetreToFootStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForMetreToFootStream "
                + " select unitconversion:mTofoot(inValue) "
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    Assert.assertEquals((Double) 3.280839895013123, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMetreToFootStream");
    ...
    public void testProcessForMetreToFoot3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 7.0455500229658785E9, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMetreToFootStream");

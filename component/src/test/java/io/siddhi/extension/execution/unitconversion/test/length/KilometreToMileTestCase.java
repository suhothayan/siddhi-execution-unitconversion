...
public class KilometreToMileTestCase {
    ...
    public void testProcessForKilometreToMile() throws Exception {
        ...
        String siddhiApp = "define stream UnitConversionForKilometreToMileStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilometreToMileStream "
                + " select unitconversion:kmTomi(inValue) "
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    AssertJUnit.assertEquals((Double) 0.621371192237334, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler("UnitConversionForKilometreToMileStream");
    ...
    public void testProcessForKilometreToMile3() throws Exception {
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    AssertJUnit.assertEquals((Double) 1.334384474046568E9, result);
                }
            }
        });
        InputHandler inputHandler = siddhiAppRuntime.getInputHandler("UnitConversionForKilometreToMileStream");
    ...
    public void testProcessForKilometreToMile4() throws Exception {
        logger.info("UnitConversionForKilometreToMileFunctionExtension4 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilometreToMileStream (inValue int); ";

        String eventFuseSiddhiApp = ("@info(name = 'query1') from UnitConversionForKilometreToMileStream "
                + " select unitconversion:kmTomi() "
                + "as UnitConversionValue "
                + " insert into OutMediationStream;");
    ...
    @Test (expectedExceptions = SiddhiAppCreationException.class)
    public void testProcessForKilometreToMile5() throws Exception {
        logger.info("UnitConversionForKilometreToMileFunctionExtension5 TestCase");
        siddhiManager = new SiddhiManager();
        String siddhiApp = "define stream UnitConversionForKilometreToMileStream (inValue string); ";
    ...
    @Test
    public void testProcessForKilometreToMile6() throws Exception {
        logger.info("UnitConversionForKilometreToMileFunctionExtension6 TestCase");

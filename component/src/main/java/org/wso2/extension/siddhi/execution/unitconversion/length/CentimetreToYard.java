...
/**
 * Siddhi Function for UnitConversion Centimetre to Yard
 */
public class CentimetreToYard extends FunctionExecutor {
    ...
    /**
     * The initialization method for CentimetreToYard, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        ...
        converter = CENTI(METRE).getConverterTo(YARD);
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to unitconversion:CentimetreToYard() function, " +

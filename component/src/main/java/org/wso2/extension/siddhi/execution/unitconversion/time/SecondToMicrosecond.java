...
/**
 * Siddhi Function for UnitConversion Second to Microsecond
 */
@Extension(
        name = "sTous",
        ...
        examples = @Example(
                ...
                description = "The value in seconds from 'UnitConversionForSecondToMicrosecondStream' input stream is" +
                        " converted into microseconds and returned to the 'OutMediationStream' output stream."
        )
)
public class SecondToMicrosecond extends FunctionExecutor {
    ...
    /**
     * The initialization method for SecondToMicrosecond, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
            siddhiAppContext) {
        converter = SECOND.getConverterTo(MICRO(SECOND));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:sTous() function, " +

...
/**
 * Siddhi Function for UnitConversion Metre to Centimetre
 */
public class MetreToCentimetre extends FunctionExecutor {
    ...
    /**
     * The initialization method for MetreToCentimetre, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        converter = METRE.getConverterTo(CENTI(METRE));
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to unitconversion:MetreToCentimetre() function, " +

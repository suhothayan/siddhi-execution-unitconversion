...
public class CentimetreToInchTestCase {
    ...
    public void testProcessForCentimetreToInch() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForCentimetreToInchStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForCentimetreToInchStream "
                + " select unitconversion:cmToinch(inValue) "
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    Assert.assertEquals((Double) 0.3937007874015748, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForCentimetreToInchStream");
    ...
    public void testProcessForCentimetreToInch3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 8.454660027559055E8, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForCentimetreToInchStream");

...
/**
 * Siddhi Function for UnitConversion Kilometre to Metre
 */
@Extension(
        name = "kmTom",
        namespace = "unitconversion",
        description = "Converts the input kilometers into meters",
        parameters = @Parameter(
                name = "p1",
                description = "The value needed to be converted from kilometers into meters",
                type = {DataType.INT, DataType.LONG, DataType.FLOAT, DataType.DOUBLE}),
        returnAttributes = @ReturnAttribute(
                description = "The value converted from kilometers to meters",
                type = {DataType.DOUBLE}),
        examples = @Example(
                description = "The kilometer values from UnitConversionForKilometreToMetreStream will be " +
                        "converted to meters and inserted in to the OutMediationStream",
                syntax = "define stream UnitConversionForKilometreToMetreStream (inValue int); \n" +
...
public class KilometreToMetre extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilometreToMetre, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader reader, SiddhiAppContext
                        siddhiAppContext) {
        converter = KILO(METRE).getConverterTo(METRE);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kmTom() function, " +

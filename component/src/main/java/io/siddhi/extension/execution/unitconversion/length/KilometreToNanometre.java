...
/**
 * Siddhi Function for UnitConversion Kilometre to Nanometre
 */
@Extension(
        name = "kmTonm",
        namespace = "unitconversion",
        description = "Function converts the input given in kilometers into nanometers.",
...
public class KilometreToNanometre extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilometreToNanometre, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        converter = KILO(METRE).getConverterTo(NANO(METRE));
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kmTonm() function, " +

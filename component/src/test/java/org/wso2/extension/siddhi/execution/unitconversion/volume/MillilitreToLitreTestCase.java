...
public class MillilitreToLitreTestCase {
    ...
    public void testProcessForMillilitreToLitre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForMillilitreToLitreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForMillilitreToLitreStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMillilitreToLitreStream");

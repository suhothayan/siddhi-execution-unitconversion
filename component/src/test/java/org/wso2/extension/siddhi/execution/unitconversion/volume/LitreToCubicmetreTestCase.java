...
public class LitreToCubicmetreTestCase {
    ...
    public void testProcessForLitreToCubicmetre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForLitreToCubicmetreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForLitreToCubicmetreStream "
                + " select unitconversion:lToCubicmetre(inValue) "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForLitreToCubicmetreStream");

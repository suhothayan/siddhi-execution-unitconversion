...
public class MileToKilometreTestCase {
    ...
    public void testProcessForMileToKilometre() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForMileToKilometreStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForMileToKilometreStream "
                + " select unitconversion:mileTokm(inValue) "
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    Assert.assertEquals((Double) 1.609344, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMileToKilometreStream");
    ...
    public void testProcessForMileToKilometre3() throws Exception {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    result = (Double) event.getData(0);
                    Assert.assertEquals((Double) 3.456039922397568E9, result);
                }
            }
        });
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForMileToKilometreStream");

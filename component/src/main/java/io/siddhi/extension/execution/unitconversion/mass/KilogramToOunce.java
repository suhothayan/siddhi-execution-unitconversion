...
/**
 * Siddhi Function for UnitConversion Kilogram to Ounce
 */
@Extension(
        name = "kgTooz",
        ...
        examples = @Example(
                ...
                description = "The value in kilograms from 'UnitConversionForKilogramToOunceStream' input stream is" +
                        " converted into ounces and returned to the 'OutMediationStream' output stream."
        )
)
public class KilogramToOunce extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilogramToOunce, this method will be called before the other methods
     *
    ...
    protected StateFactory init(ExpressionExecutor[] attributeExpressionExecutors, ConfigReader configReader,
        ...
        Unit<Mass> ounce = KILOGRAM.multiply(2.834952E-02);
        converter = KILOGRAM.getConverterTo(ounce);
        if (attributeExpressionExecutors.length != 1) {
            throw new SiddhiAppValidationException(
                    "Invalid no of arguments passed to unitconversion:kgTooz() function, " +

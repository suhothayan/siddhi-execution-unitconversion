...
public class GramToKilogramTestCase {
    ...
    public void testProcessForGramToKilogram() throws Exception {
        ...
        String executionPlan = "define stream UnitConversionForGramToKilogramStream (inValue int); ";

        String eventFuseExecutionPlan = ("@info(name = 'query1') from UnitConversionForGramToKilogramStream "
        ...
        InputHandler inputHandler = executionPlanRuntime.getInputHandler("UnitConversionForGramToKilogramStream");

...
/**
 * Siddhi Function for UnitConversion Kilometre to Foot
 */
public class KilometreToFoot extends FunctionExecutor {
    ...
    /**
     * The initialization method for KilometreToFoot, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        ...
        converter = KILO(METRE).getConverterTo(FOOT);
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to unitconversion:KilometreToFoot() function, " +
